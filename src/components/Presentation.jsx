    ...
    <>
      <div>
        <div className="jumbotron jumbotron-fluid text-center ">
          <div className="container">
            <h1 className="display-4">
              Bienvenido a Mundo Informática en San Vicente
            </h1>
            <p className="lead">
        ...
        <div className="container">
          ...
          <h2>¿Por qué elegir Mundo Informática?</h2>
          <ul>
            <li>
            ...
            <li>
              ...
              actualizados que abarcan desde programación y diseño web hasta
              seguridad cibernética y análisis de datos.
            </li>
            <li>
          ...
          <h2>Únete a la Comunidad de Mundo Informática</h2>
          <p>
          ...
          <h2>Comienza tu Viaje en el Mundo Digital</h2>
          <p>
