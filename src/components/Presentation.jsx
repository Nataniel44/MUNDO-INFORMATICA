    ...
    <>
      <div>
        <div className="jumbotron jumbotron-fluid text-center text-logo ">
          <div className="container">
            <h1 className="display-4">
              Bienvenido a el INSTITUTO <span className="text-primary"> Mundo Informática</span> en San Vicente
            </h1>
            <p className="lead">
        ...
        <div className="container">
          ...
          <h2 className="text-color">Únete a la Comunidad de Mundo Informática</h2>
          <p>
